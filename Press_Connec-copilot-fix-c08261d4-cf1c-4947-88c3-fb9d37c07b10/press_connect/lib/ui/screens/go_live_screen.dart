...
class _GoLiveScreenState extends State<GoLiveScreen>
        ...
        SizedBox(
          ...
          child: Consumer3<StreamingService, YouTubeApiService, conn_service.ConnectionService>(
            builder: (context, streamingService, youtubeService, connectionService, child) {
              ...
              final bool isStreaming = streamingService.isStreaming;
              ...
              return AnimatedButton(
                onPressed: isLoading ? null : (isStreaming ? _handleStopStream : (canStart ? _handleGoLive : null)),
  ...
  Future<void> _handleGoLive() async {
    ...
    try {
      ...
      // Step 4: Start YouTube broadcast monitoring (this will handle the transition to live)
      ...
      if (kDebugMode) {
        print('GoLiveScreen: Stream started successfully, monitoring for live status...');
      }
          ...
          builder: (context, youtubeService, child) {
            ...
            switch (youtubeService.status) {
              case YouTubeStreamStatus.testing:
                message = 'Stream is being tested by YouTube, will go live shortly...';
              ...
              case YouTubeStreamStatus.live:
                ...
                break;
              default:
                message = 'Waiting for YouTube to start your stream...';
  ...
  Future<void> _handleStopStream() async {
    ...
    try {
      ...
      if (kDebugMode) {
        print('GoLiveScreen: Stream stopped successfully');
      }
