...
class AppConfig {
  ...
  static double get defaultWatermarkOpacity => (_config['watermark']?['defaultWatermarkOpacity'] ?? 0.5).toDouble();
  static double get minWatermarkOpacity => (_config['watermark']?['minWatermarkOpacity'] ?? 0.1).toDouble();
  static double get maxWatermarkOpacity => (_config['watermark']?['maxWatermarkOpacity'] ?? 1.0).toDouble();
  static String get defaultWatermarkPath => _config['watermark']?['defaultWatermarkPath'] ?? 'assets/watermark.png';
