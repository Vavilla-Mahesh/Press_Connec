...
class YouTubeApiService extends ChangeNotifier {
  ...
  bool get shouldShowStopButton {
    return _status == YouTubeStreamStatus.live ||
        _status == YouTubeStreamStatus.testing;
  }

  /// Check if streaming is effectively live (either testing or live)
