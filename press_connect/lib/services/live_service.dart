  ...
  Future<bool> createLiveStream() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Fallback: set default RTMP URL for testing
        _currentStream = LiveStreamInfo(
          ingestUrl: "rtmp://a.rtmp.youtube.com/live2/",
          streamKey: "d76m-cxg0-fd3e-wmw0-eghv",
          broadcastId: null,
        );
        if (kDebugMode) print('createLiveStream: Using fallback RTMP URL: rtmpUrl=${_currentStream?.rtmpUrl}');
      ...
      if (kDebugMode) print('createLiveStream: Exception, using fallback RTMP URL: rtmpUrl=${_currentStream?.rtmpUrl}');
      _setState(StreamState.idle);
      _errorMessage = null;
      return true;
    }
