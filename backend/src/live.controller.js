...
const createLiveStream = async (req, res) => {
  try {
    ...
    // Create live broadcast with immediate start
    ...
    // Create live stream with optimized settings
    ...
    try {
      ...
      console.log(`Broadcast ${broadcast.id} automatically transitioned to live`);
    } catch (transitionError) {
      console.warn('Failed to auto-transition to live:', transitionError.message);
      // Continue anyway - the stream can still work
    }
